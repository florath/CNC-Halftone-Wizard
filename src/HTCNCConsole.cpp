...
void Console::setMessageSink(QPlainTextEdit *sink) { m_sink = sink; }
...
HTCNC::Console::Console()
    : m_sink(NULL), m_nextMessageSeverity(DEBUG),
      m_severityOutputThreshold(DEBUG), m_printTimestamp(true),
      m_lastTextWasHTML(false) {}
